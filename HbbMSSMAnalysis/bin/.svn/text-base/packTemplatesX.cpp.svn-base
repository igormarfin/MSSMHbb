...
void packTemplatesMass( const int iMass, const char * version) {
...
//  string sfc[nfc] = { "q", "c", "b" };
  ...
  int nTCombData = 4; /// up to 4 triggers are possible
...
//  string IgorVersion("V7");
//  string IgorVersion("V8");
//  string IgorVersion("V9");
  string IgorVersion(version);
...
// 				0.0138382, 0.0189684, 0.0206572 };
  ...
  } else if (IgorVersion == "V6" || IgorVersion=="V11" || IgorVersion=="V12" ||  IgorVersion=="V13" || IgorVersion=="V14" || IgorVersion=="V15" || IgorVersion=="V16") {
    IgorPath.assign("/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/SignalTemplates-Production2");
  } else if ((IgorVersion == "V7") || IgorVersion == "V8" ||  IgorVersion == "V9" ||  IgorVersion == "V10" ||  IgorVersion == "V040" || IgorVersion == "V060" || IgorVersion == "V080")
{
	IgorPath.assign("/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/SignalTemplates-Production_Truncated");
  ...
  std::string path_to_data = "/afs/naf.desy.de/user/r/rmankel/scratch/HbbPat/CMSSW_4_2_4_patch1/src/Analysis/HbbMSSMAnalysis/test/results/v1/";

if (IgorVersion == "V7")
{
	if (scenario == "LowMass2011")
	SashaPath.assign("theMergeList-data");
	if (scenario == "MediumMass2011")
	SashaPath.assign("theMergeList-data/MEDIUM");

	path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated/";
}
...
if (IgorVersion == "V8")
{
        ...
        path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated/test-Production-untruncated/";
}
...
if (IgorVersion == "V9")
{
        ...
        path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated_v2/";
}
...
if (IgorVersion == "V10")
{
        ...
        path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated_v3/";
}

if (IgorVersion == "V11")
{
        if (scenario == "MediumMass2012") 
        SashaPath.assign("MEDIUM");
        path_to_data="/data/user/marfin/CMSSW_5_3_3/src/Analysis/HbbMSSMAnalysis/test/Analysis2012/Blind-test-BG-only-Fit/";
	    nTCombData=1;
}
...
if (IgorVersion == "V12")
{
        if (scenario == "MediumMass2012") 
        SashaPath.assign("MEDIUM");
        path_to_data="/data/user/marfin/CMSSW_5_3_3/src/Analysis/HbbMSSMAnalysis/test/Analysis2012/No-MVA-test-BG-only-Fit/";
	    nTCombData=1;
}
...
if (IgorVersion == "V13")
{
        if (scenario == "MediumMass2012") 
        SashaPath.assign("MEDIUM");
        path_to_data="/data/user/marfin/CMSSW_5_3_3/src/Analysis/HbbMSSMAnalysis/test/Analysis2012/No-MVA-test-BG-only-Fit_v2/";
	    nTCombData=1;
}
...
if (IgorVersion == "V14")
{
        if (scenario == "MediumMass2012") 
        SashaPath.assign("MEDIUM");
        path_to_data="/data/user/marfin/CMSSW_5_3_3/src/Analysis/HbbMSSMAnalysis/test/Analysis2012/No-MVA-test-BG-only-Fit_v3/";
	    nTCombData=1;
}

if (IgorVersion == "V15" || IgorVersion=="V16")
{
        if (scenario == "MediumMass2012") 
        SashaPath.assign("MEDIUM");
        path_to_data="/data/user/marfin/CMSSW_5_3_3/src/Analysis/HbbMSSMAnalysis/test/Analysis2012/No-MVA-test-BG-only-Fit_v5/";
	    nTCombData=1;
}
...
if (IgorVersion == "V040")
{
        ...
        path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated_v3/Truncated_040/";
}
...
if (IgorVersion == "V060")
{
        ...
        path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated_v3/Truncated_060/";
}
...
if (IgorVersion == "V080")
{
        ...
        path_to_data="/data/user/marfin/CMSSW_5_0_1/src/Analysis/HbbMSSMAnalysis/test/BackgroundTemplates-Production_Truncated_v3/Truncated_080/";
}
...
if (IgorVersion == "V13" || IgorVersion== "V14") {

/// V13,V14 no onlineBtagCorr , no bbPurity
 onlineBtagCorr = false;
 bbPurity=std::string("None"); //  "MC", "DataDrivenR", "None"
}
...
bool doSystPack=true;


if (IgorVersion== "V15" || IgorVersion=="V16") {
doSystPack=false;
onlineBtagCorr =true;
bbPurity=std::string("None");
}



if (!doSystPack) nSyst=0;
  ...
  // real data
  std::string backgroundFile( Form("%s%s/TripleBtagAnalysis_SF/TripleBtagAnalysis.root",path_to_data.c_str(),SashaPath.c_str()) );
  ...
  std::string systNameSasha[] = { "JES", "SFbc", "SFq" ,"JER"};
  std::string upDownNameSasha[] = { "plus2", "minus2" };
  ...
  for (int iSyst=0; iSyst<nSyst; ++iSyst) {
    if (realDataNuisance[iSyst]) {
      ...
      for (int iUpDown=0; iUpDown<nUpDown; ++iUpDown) {
	backgroundSystFiles[iSyst][iUpDown] = Form( "%s%s/TripleBtagAnalysis_%s%s/TripleBtagAnalysis.root",path_to_data.c_str(),SashaPath.c_str(),systNameSasha[iSyst].c_str(),upDownNameSasha[iUpDown].c_str() );
...
void packTemplatesX(TString Version="V11") {

#include "Analysis/Utilities/interface/HbbMass.h"


  for (int iMass=0; iMass<nSignal; ++iMass) {
    packTemplatesMass(iMass,Version.Data());
  }
}
